...
public class leetcode_0530 {
    ...
    public static void main(String[] args) {
        leetcode_0530.Solution solution = new leetcode_0530().new Solution();
        leetcode_0530.TreeNode root = new leetcode_0530().new TreeNode(236);
        leetcode_0530.TreeNode left = new leetcode_0530().new TreeNode(104);
        leetcode_0530.TreeNode right = new leetcode_0530().new TreeNode(701);
        leetcode_0530.TreeNode ll = null;
        leetcode_0530.TreeNode lr = new leetcode_0530().new TreeNode(227);
        leetcode_0530.TreeNode rl = null;
        leetcode_0530.TreeNode rr = new leetcode_0530().new TreeNode(911);
        left.left = ll;
        left.right = lr;
        right.left = rl;
        right.right = rr;
