...
public class leetcode_0538 {
    ...
    public static void main(String[] args) {
        leetcode_0538.Solution solution = new leetcode_0538().new Solution();
        leetcode_0538.TreeNode root = new leetcode_0538().new TreeNode(4);
        leetcode_0538.TreeNode left = new leetcode_0538().new TreeNode(1);
        leetcode_0538.TreeNode right = new leetcode_0538().new TreeNode(6);
        leetcode_0538.TreeNode ll = new leetcode_0538().new TreeNode(0);
        leetcode_0538.TreeNode lr = new leetcode_0538().new TreeNode(2);
        leetcode_0538.TreeNode rl = new leetcode_0538().new TreeNode(5);
        leetcode_0538.TreeNode rr = new leetcode_0538().new TreeNode(7);
        leetcode_0538.TreeNode lrr = new leetcode_0538().new TreeNode(3);
        leetcode_0538.TreeNode rrr = new leetcode_0538().new TreeNode(8);
        left.left = ll;
        left.right = lr;
        right.left = rl;
        right.right = rr;
