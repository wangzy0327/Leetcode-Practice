...
public class interview_0405 {
    ...
    public static void main(String[] args) {
        interview_0405.Solution solution = new interview_0405().new Solution();
        interview_0405.TreeNode root = new interview_0405().new TreeNode(5);
        interview_0405.TreeNode left = new interview_0405().new TreeNode(1);
        interview_0405.TreeNode right = new interview_0405().new TreeNode(4);
        interview_0405.TreeNode ll = null;
        interview_0405.TreeNode lr = null;
        interview_0405.TreeNode rl = new interview_0405().new TreeNode(3);
        interview_0405.TreeNode rr = new interview_0405().new TreeNode(6);
        left.left = ll;
        left.right = lr;
        right.left = rl;
        right.right = rr;
