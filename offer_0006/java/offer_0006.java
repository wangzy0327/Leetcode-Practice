...
public class offer_0006 {
    ...
    public static void main(String[] args) {
        Solution solution = new offer_0006().new Solution();
        ListNode head = new offer_0006().new ListNode(1);
        ListNode h1 = new offer_0006().new ListNode(2);
        ListNode h2 = new offer_0006().new ListNode(3);
