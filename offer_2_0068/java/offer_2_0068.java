...
public class offer_2_0068 {
    ...
    public static void main(String[] args) {
        offer_2_0068.Solution solution = new offer_2_0068().new Solution();
        offer_2_0068.TreeNode root = new offer_2_0068().new TreeNode(3);
        offer_2_0068.TreeNode left = new offer_2_0068().new TreeNode(5);
        offer_2_0068.TreeNode right = new offer_2_0068().new TreeNode(1);
        offer_2_0068.TreeNode ll = new offer_2_0068().new TreeNode(6);
        offer_2_0068.TreeNode lr = new offer_2_0068().new TreeNode(2);
        offer_2_0068.TreeNode rl = new offer_2_0068().new TreeNode(0);
        offer_2_0068.TreeNode rr = new offer_2_0068().new TreeNode(8);
        left.left = ll;
        left.right = lr;
        right.left = rl;
        right.right = rr;
        root.left = left;
        root.right = right;
//        ll.left = new offer_2_0068().new TreeNode(0);
//        lr.left = new offer_2_0068().new TreeNode(3);
        lr.left = new offer_2_0068().new TreeNode(7);
        lr.right = new offer_2_0068().new TreeNode(4);
        List<String> rootStr = solution.levelOrderStr(root);
        System.out.println(Arrays.toString(rootStr.toArray(String[]::new)));
        //root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 1
        offer_2_0068.TreeNode p = left;
        offer_2_0068.TreeNode q = right;
